...
Latin *iter* (journey, route, way; also: right of passage, road). Root: **iter**.
...
A defined route through a network: the ordered sequence of nodes, stops, or waypoints that constitutes a journey as a system object, independent of any particular traveler making it. In transit vocabulary: a named line or service route. In abstract usage: any well-defined sequence of steps through a connected space.

## Derivations

| Form | Category | Meaning |
|---|---|---|
| **itero** | noun, inanimate | a route (instance; this specific numbered line or sequence) |
| **iterion** | noun of act | the act of traversing a route; a passage |
| **iteral** | adjective | of or relating to routes; sequential |
| **iteralt** | noun, habitual | one who maps, defines, or maintains routes |
